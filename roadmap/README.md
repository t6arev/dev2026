...
2. Выложить сайт на `dev2026.ru`
3. Проверить favicon, logo, OG и индексацию на живом домене
4. Обновить Яндекс.Метрику под нужные цели
5. Добрать оставшиеся кейсы и финальные баннеры
6. Пересобрать секцию кейсов на главной под 6–7 работ
